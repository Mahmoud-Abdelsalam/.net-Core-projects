...
using Base5.Application.Infrastructure;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<IAppDbContext,AppDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("KPIDbConnection")));

            ////// Add AutoMapper
            services.AddAutoMapper(Assembly.GetExecutingAssembly());
            ////// Add MediatR
            services.AddMediatR(typeof(CreateKPICommand).GetTypeInfo().Assembly);
